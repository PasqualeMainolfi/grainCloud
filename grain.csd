...
idur_min, idur_max = .1, .3
ir_min, ir_max = .0001, .1
idel_min, idel_max = .01, .01
imode = 1

isorgente = open_file("testGrain_3.wav")
; ilive = live_input(44100, 1)

features_sound_granulation("voce1", isorgente, if_min, if_max, ia_min, ia_max, ip_min, ip_max, ipan_min, ipan_max, idur_min, idur_max, ir_min, ir_max, idel_min, idel_max, imode)
  endin
